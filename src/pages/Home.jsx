    ...
    return (
        <Layout>
            <div className='absolute top-1/2 -translate-y-1/2 inset-x-0'>
                ...
                <Link to="/init" state={{ prevPath: "/" }} className='block my-4 lg:mb-24'>
                    <img src={getImageUrl('home', 'start-btn', "webp")} alt="start-btn" className='w-1/2 mx-auto transition ease-in-out delay-150 duration-300 hover:-translate-y-1 hover:scale-110' />
                </Link>
